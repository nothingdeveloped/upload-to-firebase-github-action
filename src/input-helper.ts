import { FileFormType, FireBaseConfigType, FireBaseMetadataType, Inputs, RDMethods, UploadInputs, WebhookType } from "./constants";
...
export function getInputs() : UploadInputs {
	...
	const firebaseConfig  = getFirebaseConfig(core.getInput(Inputs.FIREBASE_CONFIG))
	const fireBaseMetadata  = getfireBaseMetadata(core.getInput(Inputs.FIREBASE_METADATA))
...
function getFirebaseConfig(jsonStr : string) : FireBaseConfigType {
